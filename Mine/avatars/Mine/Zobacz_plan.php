                                    ...
                                    foreach ($dayPlan[$index] as $lesson) {
                                        if (count($lesson) >= 3) {
                                            ...
                                            if ($id != '') {
                                                ...
                                                if (
                                                    isset($lekcja_index) && $lekcja_index == $index && $rows && 
                                                    $klasaa == $lesson['Klasa'] && 
                                                    (isset($Nauczyciel_odwolany) || isset($id_nauczyciela_zastepstwo)) && 
                                                    (isset($Nauczyciel_odwolany) ? $Nauczyciel_odwolany == $id : (isset($id_nauczyciela_zastepstwo) && ($id_nauczyciela_zastepstwo == $id || $lesson['Nauczyciel'] == $id)))
                                                ){    
                                                    switch($Rodzaj){
                                                        case('Odwolaj'):
